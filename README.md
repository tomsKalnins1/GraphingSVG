...
<p>
  ...
  to a set of digitized points.</p>
<p>
  ...
  strign input for functions and directory to save the file to. It outputs one file per per function even if there are many functions
