...
//		textField.setText();
	...
	public void windowDeactivated(WindowEvent e) {
		...
		//		Lexer l = new Lexer(textField.getText());
				//System.out.println();
				//String[] tokens = l.getTokens();
				System.out.println("OK button");
				//SyntaxTree maker = new SyntaxTree();

//				System.out.println( "lexer token array from event listener" + Arrays.toString(l.tokensArr));
		
				
		//		System.out.println( "The fucking tokens" + Arrays.toString(maker.tokens));
